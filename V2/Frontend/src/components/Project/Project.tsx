      ...
      <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>URL Shortner</h3>
              <p>
              Developed a custom URL shortener API project, optimizing link management and enhancing user
              experience through concise and efficient redirection
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="40" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://itstravlr.web.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
            </div>
            </header>
            <div className="body">
              ...
              <p>
              Led the development of a full stack travel website 
              featuring robust admin and customer functionalities and
              integrated secure payment gateway for convenient transactions
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Engineered a state-of-the-art retail store management system 
              integrating Artificial Intelligence capabilities to analyze 
              purchase patterns and predict customer behavior
              </p>
            </div>
            <footer>
              <ul className="tech-list">
